...
export default function Products() {
    ...
    const galleryImages = [
        {
            src: "https://ik.imagekit.io/tarubali/tarubalioil_bbd7b6fdcd.jpg?tr=w-1280,q-90",
            alt: "Taru Bali Herbal Body Oil bottle close up"
        },
        {
            src: "https://ik.imagekit.io/tarubali/wellness_oil_750d699deb.jpg?tr=w-1024,q-90",
            alt: "Applying body massage oil on skin"
        },
        {
            src: "https://ik.imagekit.io/tarubali/tarubali_12538906b2.jpg?tr=w-1280,q-90",
            alt: "Woman with natural glowing skin smiling"
        },
        {
            src: "https://ik.imagekit.io/tarubali/taru_bali_organic_natural_wellness_oil_7db4b9fc4a.jpg?tr=w-768,q-90",
            alt: "Relaxing skincare self-care massage ritual"
        },
        {
            src: "https://ik.imagekit.io/tarubali/wellness_oil_and_herbal_soap_from_bali_0d78b8c8d6.jpg?tr=w-320,q-90",
    ...
    const hotspots = [
        {
            ...
            top: "35%",
            left: "50%",
            title: "Copper Gold Cap",
        },
        {
            id: 2,
            top: "62%",
            left: "59%",
            title: "100ml Glass Bottle",
        },
        {
            id: 3,
            top: "75%",
            left: "50%",
            title: "Minimalist Label",
        }
    ];

    return (
        <section className="relative w-full min-h-screen text-[#1b3323] px-15 py-16 md:py-50 mt-[12%] flex items-center justify-center overflow-hidden selection:bg-[#1b3323] selection:text-[#dfb76c]">
            ...
            <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-10 items-center">
                ...
                <div className="lg:col-span-6 flex flex-col items-center text-center lg:text-center space-y-8">
                    ...
                    <div className="flex flex-wrap gap-2 justify-center lg:justify-start">
                        {["Body Massage", "Daily Skin Care", "Skin Conditioning"].map((tag, idx) => (
                            <span
                                key={idx}
                    ...
                    <p className="text-base md:text-lg text-[#1b3323]/90 font-extrabold max-w-xl  cormorant-garamond-rvs">
                        Our Herbal Body Oil is a cosmetic body care product formulated with a <strong className="font-semibold text-[#1b3323]">blend of plant-based ingredients</strong>. Designed for daily body care and massage, the oil supports a smooth application experience and leaves the skin feeling soft, supple, and comfortably conditioned. Suitable for regular use as part of a daily body care routine.
                    </p>
                ...
                <div className="lg:col-span-6 flex items-start gap-4 h-full">

                    <div className="relative flex-1 aspect-[3/4] border-4 rounded-full bg-white border-[#dfb76c] overflow-hidden group ">
                        <img
